...
btnBackSpace=Button(MainFrame, width=6, height=2, font=('arial,', 16, 'bold'), text="", bg="grey", command=added_value.backspace)
...
# Membuat Tombol =
btnClear=Button(MainFrame, width=13, height=2, font=('arial,', 16, 'bold'), text="=", bg="darkgrey", command=added_value.sum_of_total)
btnClear.grid(row=1, column=2, pady=1, columnspan=3)

# Membuat Tombol +
btnAdd=Button(MainFrame, width=6, height=2, font=('arial,', 16, 'bold'), text="+", bg="lightgrey", command=lambda:added_value.operation("add"))
btnAdd.grid(row=3, column=3, pady=1)

# Membuat Tombol -
btnMin=Button(MainFrame, width=6, height=2, font=('arial,', 16, 'bold'), text="-", bg="lightgrey", command=lambda:added_value.operation("min"))
...
# Membuat Tombol √
btnAkar=Button(MainFrame, width=6, height=2, font=('arial,', 16, 'bold'), text="√", bg="lightgrey", command=added_value.squared)
